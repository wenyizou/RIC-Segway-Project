...
function sendmotor()
{
var motornum=document.getElementById("motornum").value;
var motorcmd = document.getElementById("motorcmd").value;
var operand = document.getElementById("operand").value;
var run_repeat=document.getElementById("run_repeat").value;
z='mc.cgi?motornum='+motornum+'&motorcmd='+motorcmd+'&operand='+operand+'&run_repeat='+run_repeat;
document.getElementById("showcom").innerHTML=z;
newAJAXCommand(z);
}
